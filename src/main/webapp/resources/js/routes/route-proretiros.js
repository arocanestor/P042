    ...
    angular.module("routes.retiros", ["ui.router"]).config(
        ["$locationProvider", "$stateProvider", "$urlRouterProvider", "$httpProvider", function (e, d, f, g) {
            ...
            d.state("app.programacion-retiros", {
                url: "/programacion-retiros", 
                views: {
                    main_content: b.route({
                        templateUrl: "resources/html/views/retiros/mainRetiros.html", 
                        controller: "mainRetirosCtrl",
                ...
                views: { 
                    retiros_main:  b.route({ 
                            templateUrl: "resources/html/views/retiros/crear/crearRetiros.html", 
                            controller: "crearRetirosCtrl", 
                            controllerUrl: "controllers/retiros/crear/crearRetirosCtrl" 
                        }) 
                    }, 
                    data: { 
                        title: "Nueva Programación", 
                        bread: "Nueva Programación" }, 
                        resolve: {lovs: ["$utilities", function (a) { return a.resolveLovs(c) }]
                }
            })
        }])
